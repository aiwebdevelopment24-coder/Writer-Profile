  ...
  const handleSubmitComment = (e: React.FormEvent) => {
    ...
    if (!currentUser) {
      if (onTriggerAuthRequired) {
        onTriggerAuthRequired('ব্লগে মন্তব্য করতে আপনাকে লগইন বা অ্যাকাউন্ট তৈরি করতে হবে।');
      }
      return;
    }
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-8 animate-fade-in">
      ...
      <div className="space-y-6 pt-6 border-t border-[#E6E2D8]">
        ...
        {currentUser ? (
          <form onSubmit={handleSubmitComment} className="bg-[#EFECE6] border border-[#E2DDD3] rounded-2xl p-5 space-y-4 shadow-sm">
            <div>
              ...
              <textarea
                rows={3}
                required
                placeholder="এই লেখা সম্পর্কে আপনার মূল্যবান মতামত লিখুন..."
          ...
          <div className="bg-[#FFF7E6] border border-[#C29B47]/30 p-6 rounded-2xl text-center space-y-3">
            <p className="text-xs font-bold text-[#1D1E20]">
              ব্লগে মন্তব্য করার জন্য আপনাকে অবশ্যই একাউন্ট তৈরি করতে হবে বা লগইন করতে হবে।
            </p>
            <button
              type="button"
              onClick={() => onTriggerAuthRequired('কমেন্ট করতে আপনাকে লগইন করতে হবে।')}
              className="px-5 py-2.5 bg-[#C29B47] hover:bg-[#a88338] text-white text-xs font-bold rounded-xl shadow transition-colors inline-flex items-center gap-2 cursor-pointer"
            >
