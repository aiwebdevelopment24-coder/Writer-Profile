      ...
      <main className="flex-1">
        ...
        {currentView === 'wishlist' && (
          currentUser ? (
            ...
            <div className="max-w-xl mx-auto px-4 py-20 text-center space-y-4 animate-fade-in">
              <div className="w-16 h-16 bg-[#FFF7E6] text-[#C29B47] rounded-full flex items-center justify-center mx-auto text-2xl font-bold border border-[#C29B47]/30 shadow-sm">
                ♡
              </div>
              <h2 className="text-2xl font-bold font-serif-bn text-[#1D1E20]">
                উইশলিস্ট দেখতে লগইন প্রয়োজন
              </h2>
              <p className="text-xs text-[#5C584E] leading-relaxed max-w-md mx-auto">
                আপনার পছন্দের বইগুলো সংরক্ষিত রাখতে এবং যেকোনো সময় পরবর্তীতে কিনতে অনুগ্রহ করে আপনার একাউন্টে লগইন করুন অথবা একটি নতুন একাউন্ট খুলুন।
              </p>
              <button
                onClick={() => {
                ...
                className="px-6 py-3 bg-[#C29B47] hover:bg-[#a88338] text-white font-bold text-xs rounded-xl shadow transition-colors cursor-pointer inline-flex items-center gap-2"
              >
        ...
        {currentView === 'dashboard' && currentUser && (
          <DashboardView
            ...
            onSelectBook={handleSelectBook}
            onOpenOrderModal={handleOpenOrderModal}
            onUpdateUserProfile={handleUserLoginSuccess}
          />
        )}
